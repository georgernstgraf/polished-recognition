...
Current status as of 2026-09-18 (#83 CLOSED per owner — rotation-proof session shipped in `aa94106`: same-field freeze via `ImeStartDecision`, FGS retention, disk snapshot, lifecycle trace; 237/237 tests green, installed on the OnePlus. On-device feel-check confirmation still pending — reopen on findings. Open: #74, #75, #71 feel-check, #64).
