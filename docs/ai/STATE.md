...
Current status as of 2026-09-19 (#86 CLOSED per owner — mode-preserving flush shipped `9b67336` + position-2 fix `346ba53`, on-device feel-check passed; #81 closed as implemented. Open: #87, #84, #82, #74, #75, #64).
