...
Current status as of 2026-09-19 (#81 CLOSED as fully implemented; #83 rotation-proof session shipped `aa94106` and closed 2026-09-18; #86 mode-preserving flush shipped `9b67336`. Both on-device feel-checks the owner confirmed (#71 REC counter, #83 rotation-safe session) are cleared from HANDOFF/STATE. Open: #87, #86, #84, #82, #74, #75, #64 — #86 feel-check still pending).
...
#74 v1.3.0 listing-assets release, then #75 / #64 / the newer backlog (#87, #86, #84, #82).
