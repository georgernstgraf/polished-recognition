...
**v1.2.1 RELEASED 2026-09-07 (#68): versionCode 10201, tag v1.2.1 (commit 7f7200a2) — Play verified via API (1.2.1/10201 status=completed on the ALPHA track — release.yml targets alpha, not internal as DECISIONS says; harmless, but note it), GH release has AAB + signed APK; MR !40029 updated per linsui (single 1.2.1 Build entry, old 1.1.1+1.2.0 removed, pipeline FULLY GREEN incl. rewritemeta + check apk, reply posted). Next: watch MR for merge, then #64/#67.**
...
Last cleared: 2026-09-07 (v1.2.1 released: Play verified 10201 on alpha, MR !40029 green + linsui answered).
