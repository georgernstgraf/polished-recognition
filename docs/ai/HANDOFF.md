...
4. [ ] **#71 — REC time counter in IME bar during recording** (enhancement; + drop adaptive noise-floor follow-up).
5. [ ] **#67 — disk snapshot of paused dictation** (deferred by owner, `enhancement` label; STANDALONE issue — no sub-issue link).
...
Last cleared: 2026-09-14 (v1.2.3 patch released; Play alpha verified; #77 device feel-check PASSED — closed; F-Droid watch in #78).
